    ...
    <div>
      <Swiper navigation>
        ...
        <div className='flex flex-col max-w-4xl mx-auto p-3 my-7 gap-4'>
          ...
          <p className='flex items-center mt-6 gap-2 text-grey-500  text-sm'><FaMapMarkerAlt className='text-green-700' />{listing.address}</p>
          <div className='flex gap-4'>
            ...
            {listing.offer && (<p className='bg-green-900 w-full max-w-[200px] text-white text-center p-1 rounded-md'> Rs {+listing.regularPrice - +listing.discountPrice} OFF </p>)}
          </div>
          <p className='text-grey-500'><span className='font-semibold text-grey-500'>Description - </span>{listing.description}</p>
